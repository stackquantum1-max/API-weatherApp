...
Enter a city name and see the weather update dynamically

---

## What You’ll Learn

Querying the DOM and structuring JS cleanly
Using fetch() and async/await to get API data
...
Always hide private API keys before sharing your project
Keep functions focused: one job per function
Use proper error handling to avoid breaking the app
